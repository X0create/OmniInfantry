...
static void Referee_System_Info_Update(uint8_t *Buff,Referee_System_Info_TypeDef *Referee_System_Info)
{
  switch (bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length]))
  {
    ...
    case GAME_ROBOT_HP_ID:
				Referee_System_Info->game_robot_HP.ally_1_robot_HP = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length]);
				Referee_System_Info->game_robot_HP.ally_2_robot_HP = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 2]);
				Referee_System_Info->game_robot_HP.ally_3_robot_HP = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 4]);
				Referee_System_Info->game_robot_HP.ally_4_robot_HP = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 6]);
				Referee_System_Info->game_robot_HP.ally_7_robot_HP = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 10]);
				Referee_System_Info->game_robot_HP.ally_outpost_HP = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 12]);
				Referee_System_Info->game_robot_HP.ally_base_HP    = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 14]);
    ...
    case ROBOT_STATUS_ID:
		    ...
		    Referee_System_Info->robot_status.int_robot_id = (int)Referee_System_Info->robot_status.robot_id;
    ...
    case POWER_HEAT_DATA_ID:
				...
				Referee_System_Info->power_heat_data.shooter_17mm_barrel_heat = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 10]);
...
break;
    ...
    case PROJECTILE_ALLOWANCE_ID:
      ...
      Referee_System_Info->projectile_allowance.projectile_allowance_fortress = bit8TObit16(&Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 6]);
    break;
#endif
    ...
    case RFID_STATUS_ID:
      ...
      Referee_System_Info->rfid_status.rfid_status_2 = Buff[Referee_System_Info->Index + FrameHeader_Length + CMDID_Length + 4];
    break;
#endif

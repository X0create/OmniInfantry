...
{
  USART_RxDMA_MultiBufferStart(&huart6,(uint32_t *)&(huart6.Instance->DR),(uint32_t *)Image_Trans_MultiRx_Buff[0],(uint32_t *)Image_Trans_MultiRx_Buff[1],IMAGE_TRANS_RX_LENGTH);
